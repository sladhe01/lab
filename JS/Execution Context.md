Execution context(실행 컨텍스트)는 JS엔진의 평가와 실행을 추적하기 위해 사용하는 논리적인 도구를 말한다. (보통 추상적 개념이라고 표현하는데 그 이유는 )  실행하는 데 있어 필요한 정보를 제공하는 역할을 하는 **추상적인 구조**를 뜻하는 개념이다. (실행되는 과정을 추적하는 데도 유용하다.)
